...
test.Step(
  ...
  function()
    ...
    desktop.OpenWindow("/A2.DESKTOP/APPLE.MENU/TOYS", {keep_windows=true})
    desktop.SelectAll()
    a2dtest.DHRDarkness()
    desktop.CopySelectionTo("/RAM1", false, {no_wait=true})
