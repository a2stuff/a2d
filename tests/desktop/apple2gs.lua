...
DISKARGS="-hard1 $HARDIMG -hard2 'res/NoiseTracker 3.2mg' -flop3 res/disk_a.2mg"
RESOLUTION="704x462"
...
test.Step(
  "IIgs native program",
  function()
    -- NOTE: NoiseTracker requires ROM3, otherwise on quit it gives a RESTART SYSTEM error
