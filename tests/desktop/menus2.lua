...
test.Step(
  ...
  function()
    ...
    apple2.Type("A")
    apple2.MoveMouse(apple_menu_x, 85)
    test.Expect(a2dtest.OCRScreen():find("About Apple II DeskTop"), "Apple menu should be showing")
    apple2.EscapeKey()
...
test.Step(
  ...
  function()
    ...
    apple2.EscapeKey()
    a2d.WaitForRepaint()
    test.Expect(not a2dtest.OCRScreen():find("About Apple II DeskTop"), "Apple menu should be closed")
    ...
    apple2.DownArrowKey()
    a2d.WaitForRepaint()
    test.Expect(a2dtest.OCRScreen({invert=true}):find("About Apple II DeskTop"), "should have moved down into menu")
    apple2.RightArrowKey()
    a2d.WaitForRepaint()
    test.Expect(a2dtest.OCRScreen({invert=true}):find("File"), "should have moved right")
    apple2.DownArrowKey()
    a2d.WaitForRepaint()
    test.Expect(a2dtest.OCRScreen({invert=true}):find("Open"), "should have moved down")
    apple2.DownArrowKey()
    a2d.WaitForRepaint()
    test.Expect(a2dtest.OCRScreen({invert=true}):find("Get Info"), "should have moved down")
    apple2.UpArrowKey()
    a2d.WaitForRepaint()
    test.Expect(a2dtest.OCRScreen({invert=true}):find("Open"), "should have moved up")
    apple2.LeftArrowKey()
    a2d.WaitForRepaint()
    test.Expect(a2dtest.OCRScreen():find("About Apple II DeskTop"), "should have moved left")
    apple2.EscapeKey()
    a2d.WaitForRepaint()
    test.Expect(not a2dtest.OCRScreen():find("About Apple II DeskTop"), "should have moved left")
