...
test.Step(
  ...
  function()
    ...
    apple2.Type("A")
    apple2.MoveMouse(apple_menu_x, 85)
    test.Snap("verify only Apple menu is showing")
    apple2.EscapeKey()
...
test.Step(
  ...
  function()
    ...
    apple2.DownArrowKey()
    a2d.WaitForRepaint()
    test.Snap("verify moved down")
    apple2.RightArrowKey()
    a2d.WaitForRepaint()
    test.Snap("verify moved right")
    apple2.DownArrowKey()
    a2d.WaitForRepaint()
    test.Snap("verify moved down")
    apple2.DownArrowKey()
    ...
    apple2.UpArrowKey()
    a2d.WaitForRepaint()
    test.Snap("verify moved up")
    apple2.LeftArrowKey()
    a2d.WaitForRepaint()
    test.Snap("verify moved left")
    apple2.EscapeKey()
    a2d.WaitForRepaint()
    test.Snap("verify menu closed")
