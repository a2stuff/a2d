...
test.Step(
  ...
  function()
    ...
    desktop.CopyPath("/A2.DESKTOP/SAMPLE.MEDIA/ROOM", "/A2.DESKTOP/APPLE.MENU")
    desktop.CopyPath("/A2.DESKTOP/SAMPLE.MEDIA/LOREM.IPSUM", "/A2.DESKTOP/APPLE.MENU")
    desktop.CopyPath("/A2.DESKTOP/SAMPLE.MEDIA/FONTS/ATHENS", "/A2.DESKTOP/APPLE.MENU")
    desktop.Reboot()
...
test.Step(
  ...
  function()
    desktop.RenamePath("/A2.DESKTOP/APPLE.MENU", "AM")
    desktop.CreateFolder("/A2.DESKTOP/APPLE.MENU")
    desktop.CopyPath("/A2.DESKTOP/SAMPLE.MEDIA/HELLO.WORLD", "/A2.DESKTOP/APPLE.MENU")
    desktop.CopyPath("/A2.DESKTOP/EXTRAS/BASIC.SYSTEM", "/A2.DESKTOP/APPLE.MENU")
    desktop.Reboot()
    a2d.WaitForDesktopReady()
...
test.Step(
  ...
  function()
    ...
    desktop.CopyPath("/A2.DESKTOP/SAMPLE.MEDIA/LOREM.IPSUM", "/RAM1")

    desktop.SelectPath("/RAM1/PRODOS")
    desktop.RenameSelection("PRODOS") -- avoid case changes
    ...
    desktop.SelectPath("/RAM1/LOREM.IPSUM")
    desktop.RenameSelection("LOREM.IPSUM") -- avoid case changes
    local txt = a2dtest.SnapshotDHRWithoutClock()
    desktop.RenameSelection("LOREM.SHK")
    local shk = a2dtest.SnapshotDHRWithoutClock()
    desktop.RenameSelection("LOREM.BXY")
    local bxy = a2dtest.SnapshotDHRWithoutClock()
    desktop.RenameSelection("LOREM.BNY")
    local bny = a2dtest.SnapshotDHRWithoutClock()

    for i = 1, 5 do
      desktop.RenameSelection("LOREM.IPSUM")
...
test.Step(
  ...
  function()
    ...
    desktop.RenamePath("/RAM1/FOLDER", "FOLDER.A2FC")
