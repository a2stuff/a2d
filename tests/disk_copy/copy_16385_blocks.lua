...
--[[
  Disk Copy with 16385 blocks. Verify block count is correct.
]]
test.Variants(
  {
    {"Quick Copy 16385 blocks", "quick"},
    {"Disk Copy 16385 blocks", "disk"},
  },
  function(idx, name, what)
    ...
    if what == "quick" then
      ...
      test.Snap("verify total block counts are 16385")
    end
    a2d.DialogOK()
