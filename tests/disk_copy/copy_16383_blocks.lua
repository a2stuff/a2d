...
--[[
  Disk Copy with 16383 blocks. Verify block count is correct.
]]
test.Variants(
  {
    {"Quick Copy 16383 blocks", "quick"},
    {"Disk Copy 16383 blocks", "disk"},
  },
  function(idx, name, what)
    ...
    if what == "quick" then
      ...
      test.Snap("verify total block counts are 16383")
    end
    a2d.DialogOK()
