...
DISKARGS="-hard3 $HARDIMG -hard1 sizes/image_16384_blocks.hdv -hard2 sizes/image_16384_blocks.hdv"
...
--[[
  Disk Copy with 16384 blocks. Verify block count is correct.
]]
test.Variants(
  {
    {"Quick Copy 16384 blocks", "quick"},
    {"Disk Copy 16384 blocks", "disk"},
  },
  function(idx, name, what)
    ...
    if what == "quick" then
      ...
      test.Snap("verify total block counts are 16384")
    end
    a2d.DialogOK()
