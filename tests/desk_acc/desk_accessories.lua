...
MoveDoesntRepaintTest("Minesweeper", "/A2.DESKTOP/APPLE.MENU/TOYS/MINESWEEPER")
MoveDoesntRepaintTest("Neko", "/A2.DESKTOP/APPLE.MENU/TOYS/NEKO", 0.04)
...
CloseWindowTest("Minesweeper", "/A2.DESKTOP/APPLE.MENU/TOYS/MINESWEEPER")
