...
* Change MouseKeys mode to make dragging easier and support modifiers:
  * <kbd>Space</kbd> clicks the mouse button
  * <kbd>,</kbd> (comma) presses and holds the mouse button
  * <kbd>.</kbd> (period) releases the mouse button
  * <kbd>Solid Apple</kbd> is now just a modifier as normal
...
* Horizontally center file icons with respect to their grid position.
...
* Remove support for keyboard scrolling via <kbd>Apple</kbd>+<kbd>S</kbd>.
...
* Add <kbd>Apple</kbd>+<kbd>Esc</kbd> as shortcut to clear selection and focus window.
* Add <kbd>Open Apple</kbd>+<kbd>Solid Apple</kbd>+<kbd>Esc</kbd> as shortcut to clear selection and focus desktop.
* Prevent volume icon flicker on startup with empty Disk II drives.
* Don't show About dialog when <kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>2</kbd> is pressed.
...
* Fix volume icon flicker after **Special > Check All Drives** for removable disks.
* Select volume icon after **Special > Format Disk...** / **Special > Erase Disk...**.
* Fix display of long device names in **Special > Format Disk...** / **Special > Erase Disk...** volume picker.
...
* Allow <kbd>Shift</kbd>+<kbd>Arrow</kbd> keys to extend icon selection (IIgs/Platinum IIe)
...
* Support launching CHIP-8 files.
