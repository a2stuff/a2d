...
* **Control Panels**
  * **Control Panel**
    * Allows editing the double-click speed ([#2](https://github.com/a2stuff/a2d/issues/2)), desktop pattern ([#31](https://github.com/a2stuff/a2d/issues/31)), insertion point blink speed, clock 12/24hr setting ([#220](https://github.com/a2stuff/a2d/issues/220)), and mouse tracking speed ([#273](https://github.com/a2stuff/a2d/issues/273)).
  * **Joystick**
