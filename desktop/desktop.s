...
L91D5:  yax_call JT_A2D_RELAY, $D239, $03
        yax_call JT_A2D_RELAY, $D239, $04
        rts
...
L93B8:  lda     DEVLST,y
        sta     L92DE
        yax_call JT_MLI_RELAY, $92DD, READ_BLOCK
        bne     L93DB
        yax_call JT_MLI_RELAY, $92DD, WRITE_BLOCK
        cmp     #$2B
        bne     L93DB
        lda     #$80
        sta     L942E
...
L9674:  inx
        ...
        bne     L9674
        stx     $1FC0
        yax_call JT_MLI_RELAY, $9569, RENAME
        beq     L969E
        jsr     L4030
        bne     L9696
        jmp     L9611
...
L9801:  lda     #$00
        sta     $E05F
        sta     $E10D
L9809:  yax_call JT_MLI_RELAY, $970A, OPEN
        beq     L981E
        ldx     #$80
        jsr     L4033
        beq     L9809
...
L981E:  lda     L970F
        sta     $E060
        sta     L9711
L9827:  yax_call JT_MLI_RELAY, $9710, READ
        beq     L983C
        ldx     #$80
        jsr     L4033
        beq     L9827
...
L983F:  lda     $E060
        sta     L971D
L9845:  yax_call JT_MLI_RELAY, $971C, CLOSE
        beq     L985A
        ldx     #$80
        jsr     L4033
        beq     L9845
...
L985B:  inc     $E05F
        lda     $E060
        sta     L971F
L9864:  yax_call JT_MLI_RELAY, $971E, READ
        beq     L987D
        cmp     #$4C
        beq     L989F
        ldx     #$80
...
L987D:  inc     $E10D
        ...
        lda     $E060
        sta     L9727
        yax_call JT_MLI_RELAY, $9726, READ
L989C:  lda     #$00
        rts
...
L9A60:  iny
        ...
        bne     L9A60
        stx     $1FC0
L9A70:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     L9A81
        jsr     LA49B
        jmp     L9A70
...
L9AC8:  lda     L9774,y
        ...
        lda     #$0D
        sta     L976D
L9AE0:  yax_call JT_MLI_RELAY, $9766, CREATE
        beq     L9B23
        cmp     #$47
        bne     L9B1D
        bit     L918D
...
L9B3E:  lda     L97BD
        ...
        bne     L9B88
        jsr     LA2FD
L9B48:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     L9B59
        jsr     LA49B
        jmp     L9B48
...
L9B88:  jsr     LA33B
        jsr     LA2FD
        jsr     LA40A
L9B91:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     L9BA2
        jsr     LA49B
        jmp     L9B91
...
L9BC9:  yax_call JT_MLI_RELAY, $9787, GET_FILE_INFO
        beq     L9BDA
        jsr     LA497
        jmp     L9BC9
...
L9C1A:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     L9C2B
        jsr     LA49B
        jmp     L9C1A
...
L9C2B:  lda     #$00
        sta     L9CD8
        sta     L9CD9
L9C33:  yax_call JT_MLI_RELAY, $9787, GET_FILE_INFO
        beq     L9C48
        cmp     #$46
        beq     L9C54
        jsr     LA497
...
L9C5C:  iny
        ...
        sta     $1FC0
        sta     L9CD7
L9C70:  yax_call JT_MLI_RELAY, $9787, GET_FILE_INFO
        beq     L9C95
        pha
        lda     L9CD6
        sta     $1FC0
...
L9D17:  jsr     L9D81
        bne     L9D17
        jsr     L9D9C
        yax_call JT_MLI_RELAY, $97A4, SET_MARK
L9D28:  bit     L9E18
        bmi     L9D51
        jsr     L9DE8
        bit     L9E17
        ...
        jsr     L9D62
        jsr     L9D74
        yax_call JT_MLI_RELAY, $979F, SET_MARK
        beq     L9D0C
        lda     #$FF
        sta     L9E18
        jmp     L9D0C
...
L9D62:  yax_call JT_MLI_RELAY, $973E, OPEN
        beq     L9D73
        jsr     LA49B
        jmp     L9D62
...
L9D81:  yax_call JT_MLI_RELAY, $9744, OPEN
        beq     L9D9B
        cmp     #$45
        beq     L9D96
        jsr     LA497
...
L9DA9:  lda     #$C0
        ...
        lda     #$0A
        sta     L974F
L9DB3:  yax_call JT_MLI_RELAY, $974A, READ
        beq     L9DC8
        cmp     #$4C
        beq     L9DD9
        jsr     LA49B
...
L9DD9:  lda     #$FF
        sta     L9E18
L9DDE:  yax_call JT_MLI_RELAY, $979F, GET_MARK
        rts

L9DE8:  yax_call JT_MLI_RELAY, $9752, WRITE
        beq     L9DF9
        jsr     LA497
        jmp     L9DE8

L9DF9:  yax_call JT_MLI_RELAY, $97A4, GET_MARK
        rts

L9E03:  yax_call JT_MLI_RELAY, $9739, CLOSE
        rts

L9E0D:  yax_call JT_MLI_RELAY, $9737, CLOSE
        rts
...
L9E1B:  lda     L9774,x
        ...
        cpx     #$03
        bne     L9E1B
L9E26:  yax_call JT_MLI_RELAY, $975A, CREATE
        beq     L9E6F
        cmp     #$47
        bne     L9E69
        bit     L918D
...
L9EDB:  lda     #$03
        sta     L9E79
        jsr     LA379
L9EE3:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     L9EF4
        jsr     LA49B
        jmp     L9EE3
...
L9F1E:  bit     $E05C
        ...
        jsr     LA3EF
L9F26:  jsr     LA2F1
L9F29:  yax_call JT_MLI_RELAY, $973B, DESTROY
        beq     L9F8D
        cmp     #$4E
        bne     L9F8E
        bit     L918D
...
L9F62:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        lda     L9777
        and     #$80
        bne     L9F8D
        lda     #$C3
        ...
        lda     #$07
        sta     L9774
        yax_call JT_MLI_RELAY, $9774, SET_FILE_INFO
        lda     #$0A
        sta     L9774
        jmp     L9F29
...
L9F9C:  jsr     LA2FD
        ...
        jsr     LA3EF
L9FA7:  jsr     LA2F1
L9FAA:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     L9FBB
        jsr     LA49B
        jmp     L9FAA
...
L9FBB:  lda     L977B
        cmp     #$0D
        beq     LA022
L9FC2:  yax_call JT_MLI_RELAY, $973B, DESTROY
        beq     LA022
        cmp     #$4E
        bne     LA01C
        bit     L918D
...
LA02E:  yax_call JT_MLI_RELAY, $973B, DESTROY
        beq     LA043
        cmp     #$4E
        beq     LA043
        jsr     LA49B
...
LA123:  iny
        ...
        bne     LA123
        stx     $1FC0
LA133:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     LA144
        jsr     LA49B
        jmp     LA133
...
LA173:  jsr     LA1C3
        jsr     LA2F1
LA179:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     LA18A
        jsr     LA49B
        jmp     LA179
...
LA271:  jsr     LA379
LA274:  yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        beq     LA285
        jsr     LA49B
        jmp     LA274
...
LA2AE:  bit     L9189
        bvc     LA2D4
        jsr     LA2FD
        yax_call JT_MLI_RELAY, $9774, GET_FILE_INFO
        bne     LA2D4
        lda     LA2EF
        clc
        adc     L977C
...
LA39F:  jsr     L917F
        ...
        .byte   1, 0
LA3A7:  yax_call JT_MLI_RELAY, $A3A5, CLOSE
        lda     selected_window_index
        beq     LA3CA
        sta     query_state_params2::id
        yax_call JT_A2D_RELAY, $D212, $3C
        yax_call JT_A2D_RELAY, $D215, $04
LA3CA:  ldx     L9188
        txs
        lda     #$FF
        rts

LA3D1:  yax_call JT_A2D_RELAY, $D208, $2A
        lda     input_params_state
        cmp     #A2D_INPUT_KEY
        bne     LA3EC
        lda     input_params_key
...
LA426:  jsr     LA46D
        ...
        cmp     #$0F
        beq     LA46C
        yax_call JT_MLI_RELAY, $9744, OPEN
        beq     LA449
        jsr     LA497
        jmp     LA426
...
LA449:  lda     L9749
        sta     L979B
        sta     L973A
LA452:  yax_call JT_MLI_RELAY, $979A, SET_EOF
        beq     LA463
        jsr     LA497
        jmp     LA452

LA463:  yax_call JT_MLI_RELAY, $9739, CLOSE
LA46C:  rts
...
LA479:  lda     #$07
        sta     L9787
        yax_call JT_MLI_RELAY, $9787, SET_FILE_INFO
        pha
        lda     #$0A
        sta     L9787
        pla
...
LA4C5:  .byte   0
LA4C6:  yax_call JT_MLI_RELAY, $97A9, ON_LINE
        rts
