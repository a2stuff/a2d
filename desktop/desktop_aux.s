...
awp_icon:                       ; AppleWorks Word Processing
        ...
        .byte   px(%0100100),px(%1001010),px(%1001000),px(%0011000)
        .byte   px(%0100111),px(%1001010),px(%1001000),px(%0000110)
        .byte   px(%0100100),px(%1000101),px(%0001111),px(%1111110)
...
iigs_file_icon:
        ...
        .byte   px(%0100000),px(%0000000),px(%0001000),px(%0011000)
        .byte   px(%0101111),px(%1011111),px(%0001000),px(%0000110)
        .byte   px(%0100010),px(%0000100),px(%0001111),px(%1111110)
...
str_about8:  PASCAL_STRING "December 24, 2018"
