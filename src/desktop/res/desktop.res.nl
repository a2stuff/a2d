...
.define res_string_error_unknown "Er is een onbekende fout opgetreden."
.define res_string_error_too_large_to_copy "Bestand te groot om te kopi\x10ren."
.define res_string_error_too_large_to_move "Bestand te groot om te verplaatsen."
.define res_string_error_overwrite_dir "Een map kan niet worden vervangen door een ander item. Verwijder het en probeer het opnieuw."
...
.define res_string_alert_selector_list_full "De lijst is vol. Verwijder een snelkoppeling. voordat je een nieuwe kunt toevoegen."
.define res_string_alert_window_must_be_closed "Sluit eerst een venster. Daarna kun je dit onderdeel openen."
.define res_string_alert_too_many_files "Er zijn te veel bestanden om dit onderdeel te openen!"
.define res_string_alert_too_many_windows "Te veel open vensters op het bureaublad!"
.define res_string_alert_save_changes "Wil je de wijzigingen opslaan op de systeemschijf?"
