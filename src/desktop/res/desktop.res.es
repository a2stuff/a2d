...
.define res_string_error_unknown "Se ha producido un error desconocido."
.define res_string_error_too_large_to_copy "Archivo demasiado grande para ser escrito."
.define res_string_error_too_large_to_move "Archivo demasiado grande para mover."
.define res_string_error_overwrite_dir "Una carpeta no puede ser reemplazada por otro elemento. Elim\x11elo y luego vuelva a intentarlo."
...
.define res_string_alert_selector_list_full "La lista est\x10 llena. Debe borrar un atajo antes de agregar m\x10s."
.define res_string_alert_window_must_be_closed "Tiene que cerrar una ventana antes de abrir este \x12tem."
.define res_string_alert_too_many_files "[Hay demasiados archivos para abrir este elemento!"
.define res_string_alert_too_many_windows "[Hay demasiadas ventanas abiertas en el escritorio!"
.define res_string_alert_save_changes "]Quiere guardar los cambios en el disco de sistema?"
